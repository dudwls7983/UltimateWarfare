...
void AUltimate_WarfareCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind aim event
	PlayerInputComponent->BindAction("Aim", IE_Pressed, this, &AUltimate_WarfareCharacter::ToggleAimSight);
	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			if (bUsingMotionControllers)
			{
				...
				World->SpawnActor<AUltimate_WarfareProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
			}
			else
			{
...
void AUltimate_WarfareCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AUltimate_WarfareCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AUltimate_WarfareCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
void AUltimate_WarfareCharacter::ToggleAimSight()
{
...
void AUltimate_WarfareCharacter::DoAimSight()
{

}

void AUltimate_WarfareCharacter::UnAimSight()
{

}

bool AUltimate_WarfareCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AUltimate_WarfareCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AUltimate_WarfareCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AUltimate_WarfareCharacter::TouchUpdate);
		return true;
	}
